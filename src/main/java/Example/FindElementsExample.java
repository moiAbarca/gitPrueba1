...
public class FindElementsExample {
	...
	public static void main(String[] args) throws Exception {
		...
		WebElement btnPublicar = wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(
		...
		// encontrar elementos, un DropDownList
		 WebElement dwlCategoria = wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.id("category_group"))));
		Select lista = new Select(dwlCategoria);
		lista.selectByVisibleText("Computadores y accesorios");

		WebElement titulo = wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.name("subject"))));
		...
		listaRegion.selectByVisibleText("Región Metropolitana");
		 ...
		 WebElement dwlComuna = wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.id("communes"))));
		...
		WebElement rb2 = wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.id("p_ad"))));
